	...
	return (
		...
		>
			<div className="mx-auto d-flex flex-column justify-content-center align-items-center h-100 gap-3">
				...
				<h4 className="text-center mb-3" style={{ color: "white" }}>
					...
					<div className="row justify-content-center">
						<div className="col-12 col-md-6 col-lg-4">
							<div className="d-flex">
								...
								>
									<option value="" style={{backgroundColor:'white',color: 'black'}}>Select Brands</option>
									{brands.map((brand) => (
								...
								>
									<option value="" style={{backgroundColor:'white',color: 'black'}}>Select Models</option>
